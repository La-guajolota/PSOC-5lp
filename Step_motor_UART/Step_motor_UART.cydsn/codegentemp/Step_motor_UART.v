// ======================================================================
// Step_motor_UART.v generated from TopDesign.cysch
// 09/15/2023 at 07:47
...
module top ;
    ...
    CyControlReg_v1_80 STEP_MOTOR_driver (
        .clock(1'b0),
        .control_0(Net_4),
        .control_1(Net_1),
        .control_2(Net_2),
        ...
        .control_7(Net_8),
        .reset(1'b0));
    defparam STEP_MOTOR_driver.Bit0Mode = 0;
    defparam STEP_MOTOR_driver.Bit1Mode = 0;
    defparam STEP_MOTOR_driver.Bit2Mode = 0;
    defparam STEP_MOTOR_driver.Bit3Mode = 0;
    defparam STEP_MOTOR_driver.Bit4Mode = 0;
    defparam STEP_MOTOR_driver.Bit5Mode = 0;
    defparam STEP_MOTOR_driver.Bit6Mode = 0;
    defparam STEP_MOTOR_driver.Bit7Mode = 0;
    defparam STEP_MOTOR_driver.BitValue = 0;
    defparam STEP_MOTOR_driver.BusDisplay = 0;
    defparam STEP_MOTOR_driver.ExtrReset = 0;
    defparam STEP_MOTOR_driver.NumOutputs = 4;
	...
	cy_psoc3_pins_v1_10
		#(.id("8b6cef05-6ec0-4305-b81c-dfda4e1c6aea"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("38b11db6-5f17-441b-bed9-6c90157f134d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7772fe32-212a-484d-8908-1ed47e53fbe5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    CyControlReg_v1_80 Led_indicadores (
        .clock(1'b0),
        .control_0(Net_45),
        .control_1(Net_46),
        .control_2(Net_47),
        ...
        .control_7(Net_52),
        .reset(1'b0));
    defparam Led_indicadores.Bit0Mode = 0;
    defparam Led_indicadores.Bit1Mode = 0;
    defparam Led_indicadores.Bit2Mode = 0;
    defparam Led_indicadores.Bit3Mode = 0;
    defparam Led_indicadores.Bit4Mode = 0;
    defparam Led_indicadores.Bit5Mode = 0;
    defparam Led_indicadores.Bit6Mode = 0;
    defparam Led_indicadores.Bit7Mode = 0;
    defparam Led_indicadores.BitValue = 7;
    defparam Led_indicadores.BusDisplay = 0;
    defparam Led_indicadores.ExtrReset = 0;
    defparam Led_indicadores.NumOutputs = 3;
