// ======================================================================
// Filtros.v generated from TopDesign.cysch
// 08/30/2023 at 12:14
...
module top ;
	...
	wire [0:0] tmpOE__Analog_input_net;
	wire [0:0] tmpFB_0__Analog_input_net;
	wire [0:0] tmpIO_0__Analog_input_net;
	wire [0:0] tmpINTERRUPT_0__Analog_input_net;
	electrical [0:0] tmpSIOVREF__Analog_input_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Analog_input
		 (.oe(tmpOE__Analog_input_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Analog_input_net[0:0]}),
		  .analog({Net_15}),
		  .io({tmpIO_0__Analog_input_net[0:0]}),
		  .siovref(tmpSIOVREF__Analog_input_net),
		  .interrupt({tmpINTERRUPT_0__Analog_input_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Analog_input_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
