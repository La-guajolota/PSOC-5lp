// ======================================================================
// PID_anticolision.v generated from TopDesign.cysch
// 11/22/2023 at 00:29
...
module ADC_SAR_v3_10_2 (
	...
	cy_clock_v1_0
		#(.id("64bef446-354f-4854-80dd-9d2d70e96325/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("347d7148-c585-477d-8630-c4e1f41e041a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpINTERRUPT_0__sensor_net;
	...
	cy_psoc3_pins_v1_10
		...
		sensor
		 (.oe(tmpOE__sensor_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__sensor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
