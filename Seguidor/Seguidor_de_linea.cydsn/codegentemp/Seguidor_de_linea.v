...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  .drive_mode(18'b111_111_111_111_111_111),
	...
	wire [0:0] tmpINTERRUPT_0__Opticos_net;
	electrical [0:0] tmpSIOVREF__Opticos_net;
	...
	assign tmpOE__Opticos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};

    CyControlReg_v1_80 Control_DIRECCION (
        .clock(1'b0),
        .control_0(Net_24),
        .control_1(Net_3),
        .control_2(Net_4),
        ...
        .control_6(Net_9),
        .control_7(Net_10),
        .control_bus(Net_6[5:0]),
        .reset(1'b0));
    defparam Control_DIRECCION.Bit0Mode = 0;
    defparam Control_DIRECCION.Bit1Mode = 0;
    defparam Control_DIRECCION.Bit2Mode = 0;
    defparam Control_DIRECCION.Bit3Mode = 0;
    defparam Control_DIRECCION.Bit4Mode = 0;
    defparam Control_DIRECCION.Bit5Mode = 0;
    defparam Control_DIRECCION.Bit6Mode = 0;
    defparam Control_DIRECCION.Bit7Mode = 0;
    defparam Control_DIRECCION.BitValue = 0;
    defparam Control_DIRECCION.BusDisplay = 1;
    defparam Control_DIRECCION.ExtrReset = 0;
    defparam Control_DIRECCION.NumOutputs = 6;
    ...
    defparam SENSORES.Bit3Mode = 0;
    defparam SENSORES.Bit4Mode = 0;
	...
	cy_clock_v1_0
		#(.id("76018475-602e-4373-a049-61f45bbd6929"),
		  .source_clock_id(""),
		  .divisor(0),
