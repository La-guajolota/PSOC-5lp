...
module top ;
    ...
    CyControlReg_v1_80 Segmentos_7seg (
        .clock(1'b0),
        .control_0(Net_4),
        .control_1(Net_1),
        .control_2(Net_2),
        ...
        .control_7(Net_55),
        .reset(1'b0));
    defparam Segmentos_7seg.Bit0Mode = 0;
    defparam Segmentos_7seg.Bit1Mode = 0;
    defparam Segmentos_7seg.Bit2Mode = 0;
    defparam Segmentos_7seg.Bit3Mode = 0;
    defparam Segmentos_7seg.Bit4Mode = 0;
    defparam Segmentos_7seg.Bit5Mode = 0;
    defparam Segmentos_7seg.Bit6Mode = 0;
    defparam Segmentos_7seg.Bit7Mode = 0;
    defparam Segmentos_7seg.BitValue = 127;
    defparam Segmentos_7seg.BusDisplay = 0;
    defparam Segmentos_7seg.ExtrReset = 0;
    defparam Segmentos_7seg.NumOutputs = 7;
	...
	cy_psoc3_pins_v1_10
		#(.id("e0d09860-4d24-4445-8de8-676c921f7f9f"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("26d68422-a60f-4f2e-985a-2bbea93ba7bf"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("04850406-9dc8-470b-b0e5-ac3273090673"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("dca32b98-bb8c-49b3-87e9-aee8e09f43ca"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("90c8c074-73fb-4a54-a856-01d781ccbce1"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a4362576-e986-492b-bcd1-51702968ca12"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("7b25424e-3653-45af-8799-e399deba975d"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [1:0] tmpOE__Botons_net;
	wire [1:0] tmpIO_1__Botons_net;
	wire [0:0] tmpINTERRUPT_0__Botons_net;
	electrical [0:0] tmpSIOVREF__Botons_net;
	...
	cy_psoc3_pins_v1_10
		...
		Botons
		 (.oe(tmpOE__Botons_net),
		  .y({2'b0}),
		  .fb({Net_19[1:0]}),
		  .io({tmpIO_1__Botons_net[1:0]}),
		  .siovref(tmpSIOVREF__Botons_net),
		  .interrupt({tmpINTERRUPT_0__Botons_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Botons_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};

    CyStatusReg_v1_90 Status_Botones (
        .clock(Net_12),
        .intr(Net_34),
        .status_0(1'b0),
        .status_1(1'b0),
    ...
    defparam Status_Botones.Bit5Mode = 0;
    defparam Status_Botones.Bit6Mode = 0;
    defparam Status_Botones.Bit7Mode = 0;
    defparam Status_Botones.BusDisplay = 1;
    defparam Status_Botones.Interrupt = 1;
    defparam Status_Botones.MaskValue = 3;
    defparam Status_Botones.NumInputs = 2;
	...
	wire [0:0] tmpOE__Display_0_net;
	wire [0:0] tmpFB_0__Display_0_net;
	wire [0:0] tmpIO_0__Display_0_net;
	wire [0:0] tmpINTERRUPT_0__Display_0_net;
	electrical [0:0] tmpSIOVREF__Display_0_net;

	cy_psoc3_pins_v1_10
		#(.id("aa48486b-c19b-49da-b55a-07d98d2401d4"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Display_0
		 (.oe(tmpOE__Display_0_net),
		  .y({Net_37}),
		  .fb({tmpFB_0__Display_0_net[0:0]}),
		  .io({tmpIO_0__Display_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Display_0_net),
		  .interrupt({tmpINTERRUPT_0__Display_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Display_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 Displays_mux (
        .clock(1'b0),
        .control_0(Net_37),
        .control_1(Net_58),
        .control_2(Net_59),
        ...
        .control_7(Net_64),
        .reset(1'b0));
    defparam Displays_mux.Bit0Mode = 0;
    defparam Displays_mux.Bit1Mode = 0;
    defparam Displays_mux.Bit2Mode = 0;
    defparam Displays_mux.Bit3Mode = 0;
    defparam Displays_mux.Bit4Mode = 0;
    defparam Displays_mux.Bit5Mode = 0;
    defparam Displays_mux.Bit6Mode = 0;
    defparam Displays_mux.Bit7Mode = 0;
    defparam Displays_mux.BitValue = 0;
    defparam Displays_mux.BusDisplay = 0;
    defparam Displays_mux.ExtrReset = 0;
    defparam Displays_mux.NumOutputs = 4;

	wire [0:0] tmpOE__Display_1_net;
	wire [0:0] tmpFB_0__Display_1_net;
	wire [0:0] tmpIO_0__Display_1_net;
	wire [0:0] tmpINTERRUPT_0__Display_1_net;
	electrical [0:0] tmpSIOVREF__Display_1_net;

	cy_psoc3_pins_v1_10
		#(.id("2d85d896-0dba-4b97-be89-eb927bd3e922"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Display_1
		 (.oe(tmpOE__Display_1_net),
		  .y({Net_58}),
		  .fb({tmpFB_0__Display_1_net[0:0]}),
		  .io({tmpIO_0__Display_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Display_1_net),
		  .interrupt({tmpINTERRUPT_0__Display_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Display_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Display_2_net;
	wire [0:0] tmpFB_0__Display_2_net;
	wire [0:0] tmpIO_0__Display_2_net;
	wire [0:0] tmpINTERRUPT_0__Display_2_net;
	electrical [0:0] tmpSIOVREF__Display_2_net;

	cy_psoc3_pins_v1_10
		#(.id("cf9e0577-fe54-4851-8bd1-4c5c4292c243"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Display_2
		 (.oe(tmpOE__Display_2_net),
		  .y({Net_59}),
		  .fb({tmpFB_0__Display_2_net[0:0]}),
		  .io({tmpIO_0__Display_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Display_2_net),
		  .interrupt({tmpINTERRUPT_0__Display_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Display_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Display_3_net;
	wire [0:0] tmpFB_0__Display_3_net;
	wire [0:0] tmpIO_0__Display_3_net;
	wire [0:0] tmpINTERRUPT_0__Display_3_net;
	electrical [0:0] tmpSIOVREF__Display_3_net;

	cy_psoc3_pins_v1_10
		#(.id("2f2ede1b-6abe-41a0-8f08-f838dc52cda0"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Display_3
		 (.oe(tmpOE__Display_3_net),
		  .y({Net_60}),
		  .fb({tmpFB_0__Display_3_net[0:0]}),
		  .io({tmpIO_0__Display_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Display_3_net),
		  .interrupt({tmpINTERRUPT_0__Display_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Display_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
