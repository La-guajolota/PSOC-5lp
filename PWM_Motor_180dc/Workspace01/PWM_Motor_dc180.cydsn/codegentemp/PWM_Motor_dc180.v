// ======================================================================
// PWM_Motor_dc180.v generated from TopDesign.cysch
// 09/01/2023 at 11:23
...
// LED_Driver_v1_10(BrightnessCtrl=0, ClkSource=0, CommonDrive=1, InternalClockFrequency=1200, NumCom=4, NumSeg=8, RefreshRate=300, SegmentDrive=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=LED_Driver_v1_10, CY_CONFIG_TITLE=LED_Drive, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LED_Drive, CY_INSTANCE_SHORT_NAME=LED_Drive, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=LED_Drive, )
...
module top ;
    ...
    CyStatusReg_v1_90 Botones (
        ...
        .status_7(1'b0),
        .status_bus(8'b0));
    defparam Botones.Bit0Mode = 0;
    defparam Botones.Bit1Mode = 0;
    defparam Botones.Bit2Mode = 0;
    defparam Botones.Bit3Mode = 0;
    defparam Botones.Bit4Mode = 0;
    defparam Botones.Bit5Mode = 0;
    defparam Botones.Bit6Mode = 0;
    defparam Botones.Bit7Mode = 0;
    defparam Botones.BusDisplay = 0;
    defparam Botones.Interrupt = 0;
    defparam Botones.MaskValue = 0;
    defparam Botones.NumInputs = 2;

	wire [0:0] tmpOE__Mas_net;
	wire [0:0] tmpIO_0__Mas_net;
	wire [0:0] tmpINTERRUPT_0__Mas_net;
	electrical [0:0] tmpSIOVREF__Mas_net;
	...
	cy_psoc3_pins_v1_10
		...
		Mas
		 (.oe(tmpOE__Mas_net),
		  .y({1'b0}),
		  .fb({Net_29}),
		  .io({tmpIO_0__Mas_net[0:0]}),
		  .siovref(tmpSIOVREF__Mas_net),
		  .interrupt({tmpINTERRUPT_0__Mas_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Mas_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Menos_net;
	wire [0:0] tmpIO_0__Menos_net;
	wire [0:0] tmpINTERRUPT_0__Menos_net;
	electrical [0:0] tmpSIOVREF__Menos_net;
	...
	cy_psoc3_pins_v1_10
		...
		Menos
		 (.oe(tmpOE__Menos_net),
		  .y({1'b0}),
		  .fb({Net_30}),
		  .io({tmpIO_0__Menos_net[0:0]}),
		  .siovref(tmpSIOVREF__Menos_net),
		  .interrupt({tmpINTERRUPT_0__Menos_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Menos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Driver_motor_net;
	wire [0:0] tmpFB_0__Driver_motor_net;
	wire [0:0] tmpIO_0__Driver_motor_net;
	wire [0:0] tmpINTERRUPT_0__Driver_motor_net;
	electrical [0:0] tmpSIOVREF__Driver_motor_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Driver_motor
		 (.oe(tmpOE__Driver_motor_net),
		  .y({Net_62}),
		  .fb({tmpFB_0__Driver_motor_net[0:0]}),
		  .io({tmpIO_0__Driver_motor_net[0:0]}),
		  .siovref(tmpSIOVREF__Driver_motor_net),
		  .interrupt({tmpINTERRUPT_0__Driver_motor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Driver_motor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
