...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000244u)
...
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x48000260u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG0_CFG0), 0x0084u);
