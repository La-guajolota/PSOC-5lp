...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("4a242837-9b6f-4987-babb-e57e1d5015fe"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("58fc32df-d55c-4367-be63-427d293c3c80"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("09b0b8f5-1805-413f-9b26-b27bc403d624"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9abf39bf-1b4b-4e8e-b8b3-0da42b4baa56"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7290fa15-14a0-49f9-a5f1-c0819db0ab77"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("561b97d6-2f11-4384-b869-125bb73bc0c2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    CyControlReg_v1_80 LED (
        ...
        .control_7(Net_35),
        .reset(1'b0));
    defparam LED.Bit0Mode = 0;
    defparam LED.Bit1Mode = 0;
    defparam LED.Bit2Mode = 0;
    defparam LED.Bit3Mode = 0;
    defparam LED.Bit4Mode = 0;
    defparam LED.Bit5Mode = 0;
    defparam LED.Bit6Mode = 0;
    defparam LED.Bit7Mode = 0;
    defparam LED.BitValue = 0;
    defparam LED.BusDisplay = 0;
    defparam LED.ExtrReset = 0;
    defparam LED.NumOutputs = 3;
	...
	cy_psoc3_pins_v1_10
		#(.id("42c9a454-50dd-4538-8566-4c83ca7a8a6b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("47e10abb-d148-490d-beae-5214941667f1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
