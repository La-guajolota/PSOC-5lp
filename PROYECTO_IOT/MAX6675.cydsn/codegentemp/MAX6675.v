...
module SPI_Master_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("0bd9e24e-084c-4d57-9038-7718aa602487/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Chip_Select_net;
	wire [0:0] tmpFB_0__Chip_Select_net;
	wire [0:0] tmpIO_0__Chip_Select_net;
	wire [0:0] tmpINTERRUPT_0__Chip_Select_net;
	electrical [0:0] tmpSIOVREF__Chip_Select_net;

	cy_psoc3_pins_v1_10
		#(.id("a0a9cbe4-9c4f-49e4-9433-85f7df2fe8ff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Chip_Select
		 (.oe(tmpOE__Chip_Select_net),
		  .y({Net_47}),
		  .fb({tmpFB_0__Chip_Select_net[0:0]}),
		  .io({tmpIO_0__Chip_Select_net[0:0]}),
		  .siovref(tmpSIOVREF__Chip_Select_net),
		  .interrupt({tmpINTERRUPT_0__Chip_Select_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Chip_Select_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
