...
// I2C_v3_50(Address_Decode=1, BusSpeed_kHz=50, ClockInputVisibility=false, CtlModeReplacementString=SyncCtl, EnableWakeup=false, ExternalBuffer=false, Externi2cIntrHandler=false, ExternTmoutIntrHandler=false, FF=true, Hex=false, I2C_Mode=2, I2cBusPort=0, Implementation=1, InternalUdbClockToleranceMinus=25, InternalUdbClockTolerancePlus=5, NotSlaveClockMinusTolerance=25, NotSlaveClockPlusTolerance=5, PrescalerEnabled=false, PrescalerPeriod=1, Psoc3ffSelected=false, Psoc5AffSelected=false, Psoc5lpffSelected=true, RemoveI2cff=false, RemoveI2cUdb=true, RemoveIntClock=true, RemoveTimeoutTimer=true, SclTimeoutEnabled=false, SdaTimeoutEnabled=false, Slave_Address=8, SlaveClockMinusTolerance=5, SlaveClockPlusTolerance=50, TimeoutEnabled=false, TimeoutImplementation=0, TimeOutms=25, TimeoutPeriodff=1563, TimeoutPeriodUdb=39999, UDB_MSTR=false, UDB_MULTI_MASTER_SLAVE=false, UDB_SLV=false, UdbInternalClock=false, UdbRequiredClock=800, UdbSlaveFixedPlacementEnable=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=I2C_v3_50, CY_CONFIG_TITLE=I2C_Sensores, CY_CONST_CONFIG=true, CY_CONTROL_FILE=I2C_Slave_DefaultPlacement.ctl, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=I2C_Sensores, CY_INSTANCE_SHORT_NAME=I2C_Sensores, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=I2C_Sensores, )
module I2C_v3_50_3 (
    bclk,
    clock,
    iclk,
	...
	cy_clock_v1_0
		#(.id("46381303-c795-4c55-b007-83781c98e287/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("7bacf1c6-e240-43d7-aa2f-48433b812773"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__CEROS_net;
	wire [0:0] tmpIO_0__CEROS_net;
	wire [0:0] tmpINTERRUPT_0__CEROS_net;
	electrical [0:0] tmpSIOVREF__CEROS_net;
	...
	cy_psoc3_pins_v1_10
		...
		CEROS
		 (.oe(tmpOE__CEROS_net),
		  .y({1'b0}),
		  .fb({Net_5}),
		  .io({tmpIO_0__CEROS_net[0:0]}),
		  .siovref(tmpSIOVREF__CEROS_net),
		  .interrupt({tmpINTERRUPT_0__CEROS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CEROS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Ventilador_net;
	wire [0:0] tmpFB_0__Ventilador_net;
	wire [0:0] tmpIO_0__Ventilador_net;
	wire [0:0] tmpINTERRUPT_0__Ventilador_net;
	electrical [0:0] tmpSIOVREF__Ventilador_net;

	cy_psoc3_pins_v1_10
		#(.id("0a6617dc-6805-46ad-95bf-a6e57f7bdaf1"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Ventilador
		 (.oe(tmpOE__Ventilador_net),
		  .y({Net_2492}),
		  .fb({tmpFB_0__Ventilador_net[0:0]}),
		  .io({tmpIO_0__Ventilador_net[0:0]}),
		  .siovref(tmpSIOVREF__Ventilador_net),
		  .interrupt({tmpINTERRUPT_0__Ventilador_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ventilador_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Disparador_net;
	wire [0:0] tmpFB_0__Disparador_net;
	wire [0:0] tmpIO_0__Disparador_net;
	wire [0:0] tmpINTERRUPT_0__Disparador_net;
	electrical [0:0] tmpSIOVREF__Disparador_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Disparador
		 (.oe(tmpOE__Disparador_net),
		  .y({Net_2262}),
		  .fb({tmpFB_0__Disparador_net[0:0]}),
		  .io({tmpIO_0__Disparador_net[0:0]}),
		  .siovref(tmpSIOVREF__Disparador_net),
		  .interrupt({tmpINTERRUPT_0__Disparador_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Disparador_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_2 UART (
        ...
        .rx_clk(Net_2499),
        .rx_data(Net_2500),
        .rx_interrupt(Net_2507),
        .tx(Net_2502),
        .tx_clk(Net_2503),
        .tx_data(Net_2504),
        .tx_en(Net_2505),
        .tx_interrupt(Net_2506));
	...
	cy_psoc3_pins_v1_10
		#(.id("b95e4d0a-f097-430e-ad57-8266714b97f8"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("9c8b433c-e9c2-4397-95fa-519e0101d3bf"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("374c0738-1d2a-4745-a3bf-3bf31ea88f65"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("03a398f1-a6eb-498e-91b4-4d2f5ac33f08"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_50_4 SPIM (
        ...
        .mosi(Net_23),
        .reset(1'b0),
        .rx_interrupt(Net_2731),
        .sclk(Net_25),
        .sdat(Net_2732),
        .ss(Net_2735),
        .tx_interrupt(Net_2734));
	...
	cy_psoc3_pins_v1_10
		#(.id("23084b30-c3e3-4b05-8f16-e7fb42d7f11b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
