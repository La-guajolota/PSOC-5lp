// ======================================================================
// DOMOTICA_PROYECTO.v generated from TopDesign.cysch
// 10/31/2023 at 09:40
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("077e2073-291a-41c5-a0c9-a82fb1be073d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1af18f3b-ae94-4193-bc9d-a202af12df54"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("dc1aac1a-ee05-49cc-9244-88bae2a05532"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("dac51ffa-2f4f-4fdc-a498-c564e7c6ab8c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b9cc2418-3ab9-4bc7-a672-0bfd2a423b76"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4dd3b88a-d14f-4eba-87e2-8055497989b9"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    defparam UART_PC.HwTXEnSignal = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("2f7e1e6e-9833-4dde-9898-337f262d63a2"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d68848e3-a0f4-4c37-b63b-bf7b80fdf750"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5a19e20f-91dd-49c1-ade4-a514ce5fe096"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6beaa120-4ae0-461d-9cdd-f61ea327814f"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__ventalidor_net;
	wire [0:0] tmpFB_0__ventalidor_net;
	wire [0:0] tmpIO_0__ventalidor_net;
	wire [0:0] tmpINTERRUPT_0__ventalidor_net;
	electrical [0:0] tmpSIOVREF__ventalidor_net;

	cy_psoc3_pins_v1_10
		#(.id("b32e77ce-81a9-483b-a28d-676369672cd2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ventalidor
		 (.oe(tmpOE__ventalidor_net),
		  .y({Net_292}),
		  .fb({tmpFB_0__ventalidor_net[0:0]}),
		  .io({tmpIO_0__ventalidor_net[0:0]}),
		  .siovref(tmpSIOVREF__ventalidor_net),
		  .interrupt({tmpINTERRUPT_0__ventalidor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ventalidor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("39a2e827-4b14-4d23-997d-2ddd29387ec2"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4deee82f-02fd-452c-8abc-8f19f7aeddbb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
