...
#define BS_UDB_1_0_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000700u)
...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000788u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000794u)
