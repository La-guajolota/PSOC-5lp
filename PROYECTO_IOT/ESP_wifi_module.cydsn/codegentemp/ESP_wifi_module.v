...
module UART_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("bd3f487f-4a5d-4d7d-b94a-e874f1803fab/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1085069444.44444"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Rojo_net;
	wire [0:0] tmpFB_0__Rojo_net;
	wire [0:0] tmpIO_0__Rojo_net;
	wire [0:0] tmpINTERRUPT_0__Rojo_net;
	electrical [0:0] tmpSIOVREF__Rojo_net;
	...
	cy_psoc3_pins_v1_10
		...
		Rojo
		 (.oe(tmpOE__Rojo_net),
		  .y({Net_4}),
		  .fb({tmpFB_0__Rojo_net[0:0]}),
		  .io({tmpIO_0__Rojo_net[0:0]}),
		  .siovref(tmpSIOVREF__Rojo_net),
		  .interrupt({tmpINTERRUPT_0__Rojo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rojo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Verde_net;
	wire [0:0] tmpFB_0__Verde_net;
	wire [0:0] tmpIO_0__Verde_net;
	wire [0:0] tmpINTERRUPT_0__Verde_net;
	electrical [0:0] tmpSIOVREF__Verde_net;

	cy_psoc3_pins_v1_10
		#(.id("21df05da-9b19-413d-8520-d454b2a713f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Verde
		 (.oe(tmpOE__Verde_net),
		  .y({Net_1}),
		  .fb({tmpFB_0__Verde_net[0:0]}),
		  .io({tmpIO_0__Verde_net[0:0]}),
		  .siovref(tmpSIOVREF__Verde_net),
		  .interrupt({tmpINTERRUPT_0__Verde_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Verde_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Azul_net;
	wire [0:0] tmpFB_0__Azul_net;
	wire [0:0] tmpIO_0__Azul_net;
	wire [0:0] tmpINTERRUPT_0__Azul_net;
	electrical [0:0] tmpSIOVREF__Azul_net;

	cy_psoc3_pins_v1_10
		#(.id("b79db9c4-91a7-4741-a6f7-32eca4a83e8e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Azul
		 (.oe(tmpOE__Azul_net),
		  .y({Net_2}),
		  .fb({tmpFB_0__Azul_net[0:0]}),
		  .io({tmpIO_0__Azul_net[0:0]}),
		  .siovref(tmpSIOVREF__Azul_net),
		  .interrupt({tmpINTERRUPT_0__Azul_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Azul_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("9c4b031b-5ac6-4d8d-8f81-662f33f591d5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Naranja_net;
	wire [0:0] tmpFB_0__Naranja_net;
	wire [0:0] tmpIO_0__Naranja_net;
	wire [0:0] tmpINTERRUPT_0__Naranja_net;
	electrical [0:0] tmpSIOVREF__Naranja_net;

	cy_psoc3_pins_v1_10
		#(.id("4567d891-9363-407f-990f-fe797e72ffc6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Naranja
		 (.oe(tmpOE__Naranja_net),
		  .y({Net_3}),
		  .fb({tmpFB_0__Naranja_net[0:0]}),
		  .io({tmpIO_0__Naranja_net[0:0]}),
		  .siovref(tmpSIOVREF__Naranja_net),
		  .interrupt({tmpINTERRUPT_0__Naranja_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Naranja_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("6204e176-6905-426e-a4ab-67ee2ded01d5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7d5089a6-58fa-49de-885e-9f179dd54d91"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
