// ======================================================================
// Simulacion_sensores_en_linea.v generated from TopDesign.cysch
// 09/10/2023 at 11:52
...
module top ;
    ...
    defparam Debouncer.SignalWidth = 4;
	...
	wire [3:0] tmpOE__SENSORES_net;
	wire [3:0] tmpIO_3__SENSORES_net;
	wire [0:0] tmpINTERRUPT_0__SENSORES_net;
	electrical [0:0] tmpSIOVREF__SENSORES_net;
	...
	cy_psoc3_pins_v1_10
		...
		SENSORES
		 (.oe(tmpOE__SENSORES_net),
		  .y({4'b0}),
		  .fb({Net_28[3:0]}),
		  .io({tmpIO_3__SENSORES_net[3:0]}),
		  .siovref(tmpSIOVREF__SENSORES_net),
		  .interrupt({tmpINTERRUPT_0__SENSORES_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SENSORES_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
