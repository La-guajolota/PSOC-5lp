// ======================================================================
// Proyecto_resistencias_calefactoras_estrella_abierta_ConteoSemiciclos.v generated from TopDesign.cysch
// 11/30/2023 at 20:52
...
module top ;
    ...
    GlitchFilter_v2_0 ZC_0 (
        .clock(Net_197),
        .d(Net_45),
        .q(Net_43),
        .reset(1'b0));
    defparam ZC_0.BypassFilter = 0;
    defparam ZC_0.GlitchLength = 10;
    defparam ZC_0.SignalWidth = 1;
    ...
    defparam Actuadores.NumOutputs = 2;
    ...
    GlitchFilter_v2_0 ZC_1 (
        .clock(Net_197),
        .d(Net_48),
        .q(Net_49),
        .reset(1'b0));
    defparam ZC_1.BypassFilter = 0;
    defparam ZC_1.GlitchLength = 10;
    defparam ZC_1.SignalWidth = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("08e29b92-381f-4eb2-8bb1-c69a55ad0f0d"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    begin : demux_1
        ...
        always @(Net_92 or Net_56)
        begin
            case (Net_56[1:0])
                2'b00:
                begin
                    tmp__demux_1_0_reg = Net_92;
                ...
                begin
                    ...
                    tmp__demux_1_1_reg = 1'b0;
                    tmp__demux_1_2_reg = 1'b0;
                    tmp__demux_1_3_reg = Net_92;
                end
            endcase
        end
        assign Net_201 = tmp__demux_1_0_reg;
        assign Net_84 = tmp__demux_1_1_reg;
        assign Net_85 = tmp__demux_1_2_reg;
        assign Net_86 = tmp__demux_1_3_reg;
    end
    // -- De Mux end --
    ...
    begin : demux_2
        ...
        assign Net_87 = tmp__demux_2_1_reg;
        assign Net_88 = tmp__demux_2_2_reg;
        assign Net_89 = tmp__demux_2_3_reg;
    end
    // -- De Mux end --
	...
	cy_psoc3_pins_v1_10
		#(.id("5f7578a9-f25c-4900-b6fe-ed5665e8ba67"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("dc3ce685-1456-405e-b933-2a12215a5dd2"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
