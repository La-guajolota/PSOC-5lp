...
#if !defined(CY_STATUS_REG_Control_manual_H) /* CY_STATUS_REG_Control_manual_H */
#define CY_STATUS_REG_Control_manual_H
...
#define Control_manual_STATUS_INTR_ENBL    0x10u
...
#define Control_manual_INPUTS              5
